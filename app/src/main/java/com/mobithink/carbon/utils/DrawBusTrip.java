...
/**
 * Created by mplaton on 08/03/2017.
 */
...
public class DrawBusTrip {
    ...
    public DrawBusTrip(onDrawRoute dlg, Context ctx) {
        this.context = ctx;
    ...
    public DrawBusTrip setToLatLong(double tolat, double tolog) {
        this.to_lat = tolat;
        this.to_log = tolog;
        return this;
    }

    public DrawBusTrip setGmapAndKey(String googlekey, GoogleMap gmap) {
        this.google_key = googlekey;
        this.g_map = gmap;
        return this;
    }

    public DrawBusTrip setZoomLevel(float zoomlevel) {
        this.zoom_level = zoomlevel;
        return this;
    }

    public DrawBusTrip setColorHash(String colorhash) {
        this.color_hash = colorhash;
        return this;
    }

    public DrawBusTrip setLoader(boolean showloader){
        this.show_loader = showloader;
        return this;
    }

    public DrawBusTrip setLoaderMsg(String loadermsg){
    ...
    public void run() {
        if (google_key.equals("")) {
            Toast.makeText(context, "Ajoutez une clé API Google", Toast.LENGTH_SHORT).show();
            return;
        }
